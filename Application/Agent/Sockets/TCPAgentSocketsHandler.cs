...
namespace Application.Agent.Sockets
{
    ...
    {
        public TCPAgentSocketsHandler(Application.Logger.ILogger logger, int port, AgentManager agentManager, AgentRequestReceivedHandler agentRequestReceivedHandler)
